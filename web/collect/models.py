...
class AuthTest(db.Model):
    ...
    auth_req_time   = db.Column(db.DateTime)      # 认证请求时间
    auth_succ_time  = db.Column(db.DateTime)       # 认证成功时间
...
class HttpTest(db.Model):
    ...
    http_req_start_time = db.Column(db.DateTime)      # HTTP请求开始时间
    http_req_end_time   = db.Column(db.DateTime)       # HTTP请求完成时间
...
class RoamTest(db.Model):
    ...
    roam_reassoc_req_time = db.Column(db.DateTime)     # 漫游重关联请求开始时间
    assocsucc_time        = db.Column(db.DateTime)     # 关联成功时间
